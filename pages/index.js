...
import deved from "../public/juan.png";
...
export default function Home() {
    ...
    return (
        <div className={darkMode ? "dark" : ""}>
            <Head>
                <title>Juan de Miguel Portfolio</title>
            ...
            <main className="bg-white px-10 md:px-20 lg:px-4 dark:bg-gray-900">
                ...
                <section>
                    ...
                    <div className="lg:flex gap-10">
                        <div className="text-center shadow-lg p-10 rounded-xl my-10 dark:bg-gray-700 dark:text-white">
